...
public class AirportService {
    ...
    public List<HubInfoProjection> getAllAirports() {
        return airportRepository.getAllAirports();
    }

    public List<HubInfoProjection> getAirportsByStateId(int stateId) {
        return airportRepository.getAirportsByStateId(stateId);
    }
